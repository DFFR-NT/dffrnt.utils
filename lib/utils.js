...
// FUNCTIONS
	...
	class LG  {
		 ...
		 * @memberof LG
		 */
		static IF		(...args) { setTimeout(()=>CFG.Debug&&args.length&&console.log(...args),0); }
		/**
		 ...
		 * @memberof LG
		 */
		static Timed	(func, id, prefix, suffix, color) {
...
// EXPORTS
	...
	// Globals
		module.exports = {
			SetSettings, colors, Assign, Imm, StrTime, ROOTD, LJ, path, os, fs,
			CNAME, ARGS, TYPE, EXTEND, HIDDEN, DEFINE, NIL, UoN, IaN, IS,
